# -*- coding: utf-8 -*-
"""
Created on Tue May 26 10:19:52 2020
...
class DrugDataset(utils.Dataset):
    ...
    # 重新寫load_shapes，裏面包含自己的類別,可以任意添加
    ...
    def load_shapes(self, count, img_floder, mask_floder, imglist, dataset_root_path):
        ...
        """
        # Add classes,可通過這種方式擴展多個物體
        self.add_class("shapes", 1, "Red_Pyramid")
    ...
    def load_mask(self, image_id):
        ...
        for i in range(len(labels)):
            if labels[i].find("Red_Pyramid") != -1:
                labels_form.append("Red_Pyramid")
...
#基礎設置
dataset_root_path="training_data/red_pyramid_training_data/" # where your training pics are 
